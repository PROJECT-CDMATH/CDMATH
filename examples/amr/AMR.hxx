...
public:
	...
	GenericSolver* getGenericSolver( void ) const ;
	...
	void compute(const GenericSolver& genericSolver) ;
	...
	double
	unsteadyAMRDriver(double currentTime, const GenericSolver& genericSolver);

	void
	unsteadyAMRDriverHigherLevels(int curLevel, double currentTime, const GenericSolver& genericSolver);
	...
	void refinement(const std::vector<const INTERP_KERNEL::BoxSplittingOptions*>& bsos,const GenericSolver& genericSolver) ;
