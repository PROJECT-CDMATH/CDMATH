...
valr1_1  = MEDFLOAT([0.0,1.0, 2.0,3.0, 10.0,11.0, 12.0,13.0, 20.0,21.0, 22.0,23.0]) #/* 2 composantes*/
...
valr1_2  = MEDFLOAT([ 0.0,1.0, 2.0,3.0, 10.0,11.0,   12.0,13.0, 20.0,21.0, 22.0,23.0 ])  #/* 2 composantes*/
valr1_2p = MEDFLOAT([                                12.0,13.0, 20.0,21.0, 22.0,23.0 ])  #/* 2 composantes*/
...
valr1_3  = MEDFLOAT([ 0.0,1.0, 2.0,3.0, 10.0,11.0, 12.0,13.0, 20.0,21.0, 22.0,23.0]) #/* 2 composantes*/
valr1_3p = MEDFLOAT([         2.0,3.0, 10.0,11.0                                  ]) #/* 2 composantes profil1 */
...
ncomp2  = 3
nval2   = 5  #/*5 valeurs */
valr2  = MEDINT([ 0,1,2, 10,11,12, 20,21,22, 30,31,32, 40,41,42]) #              /* 3 composantes*/
valr2p = MEDINT([ 0,1,2,           20,21,22,           40,41,42]) #              /* 3 composantes*/
...
MEDfieldCr(fid,nomcha1,MED_FLOAT64,ncomp1,comp1,unit1,dtunit,maa1)

# /* creation du champ entier n°2 */
MEDfieldCr(fid,nomcha2,MED_INT32,ncomp2,comp2,unit2,dtunit,maa2)
...
MEDfieldCr(fid,nomcha3,MED_INT32,ncomp3,comp3,unit3,dtunit,maa1)
