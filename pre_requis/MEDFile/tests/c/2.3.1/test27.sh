...
${CHECKER} ${EXECDIR}/${file} > ${output} 2>&1 && ${H5DUMP} -a /ENS_MAA/grille_cartesienne/DIM -a /ENS_MAA/grille_cartesienne/DES -a /ENS_MAA/grille_cartesienne/TYP -a /ENS_MAA/grille_cartesienne/GTY -g /ENS_MAA/grille_cartesienne/NOE -a /ENS_MAA/grille_standard/DIM -a /ENS_MAA/grille_standard/DES -a /ENS_MAA/grille_standard/TYP -a /ENS_MAA/grille_standard/GTY -g /ENS_MAA/grille_standard/NOE  -a /ENS_MAA/maillage\ vide/DIM -a /ENS_MAA/maillage\ vide/DES -a /ENS_MAA/maillage\ vide/TYP -g /INFOS_GENERALES ${BUILDDIR}/${file}.med > ${BUILDDIR}/${file}.dump  && ( \
