...
class med_memfile(_object):
    ...
    if _newclass:app_image_ptr = _swig_property(_medfamily.med_memfile_app_image_ptr_get, _medfamily.med_memfile_app_image_ptr_set)
    ...
    if _newclass:app_image_size = _swig_property(_medfamily.med_memfile_app_image_size_get, _medfamily.med_memfile_app_image_size_set)
    ...
    if _newclass:ref_count = _swig_property(_medfamily.med_memfile_ref_count_get, _medfamily.med_memfile_ref_count_set)
    ...
    if _newclass:fapl_image_ptr = _swig_property(_medfamily.med_memfile_fapl_image_ptr_get, _medfamily.med_memfile_fapl_image_ptr_set)
    ...
    if _newclass:fapl_image_size = _swig_property(_medfamily.med_memfile_fapl_image_size_get, _medfamily.med_memfile_fapl_image_size_set)
    ...
    if _newclass:fapl_ref_count = _swig_property(_medfamily.med_memfile_fapl_ref_count_get, _medfamily.med_memfile_fapl_ref_count_set)
    ...
    if _newclass:vfd_image_ptr = _swig_property(_medfamily.med_memfile_vfd_image_ptr_get, _medfamily.med_memfile_vfd_image_ptr_set)
    ...
    if _newclass:vfd_image_size = _swig_property(_medfamily.med_memfile_vfd_image_size_get, _medfamily.med_memfile_vfd_image_size_set)
    ...
    if _newclass:vfd_ref_count = _swig_property(_medfamily.med_memfile_vfd_ref_count_get, _medfamily.med_memfile_vfd_ref_count_set)
    __swig_setmethods__["flags"] = _medfamily.med_memfile_flags_set
    __swig_getmethods__["flags"] = _medfamily.med_memfile_flags_get
    if _newclass:flags = _swig_property(_medfamily.med_memfile_flags_get, _medfamily.med_memfile_flags_set)
    def __init__(self): 
