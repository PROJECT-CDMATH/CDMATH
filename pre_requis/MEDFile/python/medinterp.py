...
class SwigPyIterator_medinterp_module(_object):
    ...
    def value(self): return _medinterp.SwigPyIterator_medinterp_module_value(self)
    def incr(self, n=1): return _medinterp.SwigPyIterator_medinterp_module_incr(self, n)
    def decr(self, n=1): return _medinterp.SwigPyIterator_medinterp_module_decr(self, n)
    def distance(self, *args): return _medinterp.SwigPyIterator_medinterp_module_distance(self, *args)
    def equal(self, *args): return _medinterp.SwigPyIterator_medinterp_module_equal(self, *args)
    def copy(self): return _medinterp.SwigPyIterator_medinterp_module_copy(self)
    def next(self): return _medinterp.SwigPyIterator_medinterp_module_next(self)
    def __next__(self): return _medinterp.SwigPyIterator_medinterp_module___next__(self)
    def previous(self): return _medinterp.SwigPyIterator_medinterp_module_previous(self)
    def advance(self, *args): return _medinterp.SwigPyIterator_medinterp_module_advance(self, *args)
    def __eq__(self, *args): return _medinterp.SwigPyIterator_medinterp_module___eq__(self, *args)
    def __ne__(self, *args): return _medinterp.SwigPyIterator_medinterp_module___ne__(self, *args)
    def __iadd__(self, *args): return _medinterp.SwigPyIterator_medinterp_module___iadd__(self, *args)
    def __isub__(self, *args): return _medinterp.SwigPyIterator_medinterp_module___isub__(self, *args)
    def __add__(self, *args): return _medinterp.SwigPyIterator_medinterp_module___add__(self, *args)
    def __sub__(self, *args): return _medinterp.SwigPyIterator_medinterp_module___sub__(self, *args)
...
class med_filter(_object):
    ...
    if _newclass:nspaces = _swig_property(_medinterp.med_filter_nspaces_get, _medinterp.med_filter_nspaces_set)
    ...
    if _newclass:memspace = _swig_property(_medinterp.med_filter_memspace_get, _medinterp.med_filter_memspace_set)
    ...
    if _newclass:diskspace = _swig_property(_medinterp.med_filter_diskspace_get, _medinterp.med_filter_diskspace_set)
    ...
    if _newclass:nentity = _swig_property(_medinterp.med_filter_nentity_get, _medinterp.med_filter_nentity_set)
    ...
    if _newclass:nvaluesperentity = _swig_property(_medinterp.med_filter_nvaluesperentity_get, _medinterp.med_filter_nvaluesperentity_set)
    ...
    if _newclass:nconstituentpervalue = _swig_property(_medinterp.med_filter_nconstituentpervalue_get, _medinterp.med_filter_nconstituentpervalue_set)
    ...
    if _newclass:constituentselect = _swig_property(_medinterp.med_filter_constituentselect_get, _medinterp.med_filter_constituentselect_set)
    ...
    if _newclass:switchmode = _swig_property(_medinterp.med_filter_switchmode_get, _medinterp.med_filter_switchmode_set)
    ...
    if _newclass:filterarraysize = _swig_property(_medinterp.med_filter_filterarraysize_get, _medinterp.med_filter_filterarraysize_set)
    ...
    if _newclass:filterarray23v30 = _swig_property(_medinterp.med_filter_filterarray23v30_get, _medinterp.med_filter_filterarray23v30_set)
    ...
    if _newclass:profilearraysize = _swig_property(_medinterp.med_filter_profilearraysize_get, _medinterp.med_filter_profilearraysize_set)
    ...
    if _newclass:storagemode = _swig_property(_medinterp.med_filter_storagemode_get, _medinterp.med_filter_storagemode_set)
    ...
    if _newclass:profilename = _swig_property(_medinterp.med_filter_profilename_get, _medinterp.med_filter_profilename_set)
    def __init__(self): 
...
class med_file_version(_object):
    ...
    if _newclass:majeur = _swig_property(_medinterp.med_file_version_majeur_get, _medinterp.med_file_version_majeur_set)
    ...
    if _newclass:mineur = _swig_property(_medinterp.med_file_version_mineur_get, _medinterp.med_file_version_mineur_set)
    ...
    if _newclass:release = _swig_property(_medinterp.med_file_version_release_get, _medinterp.med_file_version_release_set)
    def __init__(self): 
...
class med_memfile(_object):
    ...
    if _newclass:app_image_ptr = _swig_property(_medinterp.med_memfile_app_image_ptr_get, _medinterp.med_memfile_app_image_ptr_set)
    ...
    if _newclass:app_image_size = _swig_property(_medinterp.med_memfile_app_image_size_get, _medinterp.med_memfile_app_image_size_set)
    ...
    if _newclass:ref_count = _swig_property(_medinterp.med_memfile_ref_count_get, _medinterp.med_memfile_ref_count_set)
    ...
    if _newclass:fapl_image_ptr = _swig_property(_medinterp.med_memfile_fapl_image_ptr_get, _medinterp.med_memfile_fapl_image_ptr_set)
    ...
    if _newclass:fapl_image_size = _swig_property(_medinterp.med_memfile_fapl_image_size_get, _medinterp.med_memfile_fapl_image_size_set)
    ...
    if _newclass:fapl_ref_count = _swig_property(_medinterp.med_memfile_fapl_ref_count_get, _medinterp.med_memfile_fapl_ref_count_set)
    ...
    if _newclass:vfd_image_ptr = _swig_property(_medinterp.med_memfile_vfd_image_ptr_get, _medinterp.med_memfile_vfd_image_ptr_set)
    ...
    if _newclass:vfd_image_size = _swig_property(_medinterp.med_memfile_vfd_image_size_get, _medinterp.med_memfile_vfd_image_size_set)
    ...
    if _newclass:vfd_ref_count = _swig_property(_medinterp.med_memfile_vfd_ref_count_get, _medinterp.med_memfile_vfd_ref_count_set)
    __swig_setmethods__["flags"] = _medinterp.med_memfile_flags_set
    __swig_getmethods__["flags"] = _medinterp.med_memfile_flags_get
    if _newclass:flags = _swig_property(_medinterp.med_memfile_flags_get, _medinterp.med_memfile_flags_set)
    def __init__(self): 
...
class MEDBOOL(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _medinterp.MEDBOOL_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _medinterp.MEDBOOL___nonzero__(self)
    def __bool__(self): return _medinterp.MEDBOOL___bool__(self)
    def __len__(self): return _medinterp.MEDBOOL___len__(self)
    def pop(self): return _medinterp.MEDBOOL_pop(self)
    def __getslice__(self, *args): return _medinterp.MEDBOOL___getslice__(self, *args)
    def __setslice__(self, *args): return _medinterp.MEDBOOL___setslice__(self, *args)
    def __delslice__(self, *args): return _medinterp.MEDBOOL___delslice__(self, *args)
    def __delitem__(self, *args): return _medinterp.MEDBOOL___delitem__(self, *args)
    def __getitem__(self, *args): return _medinterp.MEDBOOL___getitem__(self, *args)
    def __setitem__(self, *args): return _medinterp.MEDBOOL___setitem__(self, *args)
    def append(self, *args): return _medinterp.MEDBOOL_append(self, *args)
    def empty(self): return _medinterp.MEDBOOL_empty(self)
    def size(self): return _medinterp.MEDBOOL_size(self)
    def clear(self): return _medinterp.MEDBOOL_clear(self)
    def swap(self, *args): return _medinterp.MEDBOOL_swap(self, *args)
    def get_allocator(self): return _medinterp.MEDBOOL_get_allocator(self)
    def begin(self): return _medinterp.MEDBOOL_begin(self)
    def end(self): return _medinterp.MEDBOOL_end(self)
    def rbegin(self): return _medinterp.MEDBOOL_rbegin(self)
    def rend(self): return _medinterp.MEDBOOL_rend(self)
    def pop_back(self): return _medinterp.MEDBOOL_pop_back(self)
    def erase(self, *args): return _medinterp.MEDBOOL_erase(self, *args)
    def __init__(self, *args): 
        this = _medinterp.new_MEDBOOL(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _medinterp.MEDBOOL_push_back(self, *args)
    def front(self): return _medinterp.MEDBOOL_front(self)
    def back(self): return _medinterp.MEDBOOL_back(self)
    def assign(self, *args): return _medinterp.MEDBOOL_assign(self, *args)
    def resize(self, *args): return _medinterp.MEDBOOL_resize(self, *args)
    def insert(self, *args): return _medinterp.MEDBOOL_insert(self, *args)
    def reserve(self, *args): return _medinterp.MEDBOOL_reserve(self, *args)
    def capacity(self): return _medinterp.MEDBOOL_capacity(self)
...
class MEDFLOAT(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _medinterp.MEDFLOAT_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _medinterp.MEDFLOAT___nonzero__(self)
    def __bool__(self): return _medinterp.MEDFLOAT___bool__(self)
    def __len__(self): return _medinterp.MEDFLOAT___len__(self)
    def pop(self): return _medinterp.MEDFLOAT_pop(self)
    def __getslice__(self, *args): return _medinterp.MEDFLOAT___getslice__(self, *args)
    def __setslice__(self, *args): return _medinterp.MEDFLOAT___setslice__(self, *args)
    def __delslice__(self, *args): return _medinterp.MEDFLOAT___delslice__(self, *args)
    def __delitem__(self, *args): return _medinterp.MEDFLOAT___delitem__(self, *args)
    def __getitem__(self, *args): return _medinterp.MEDFLOAT___getitem__(self, *args)
    def __setitem__(self, *args): return _medinterp.MEDFLOAT___setitem__(self, *args)
    def append(self, *args): return _medinterp.MEDFLOAT_append(self, *args)
    def empty(self): return _medinterp.MEDFLOAT_empty(self)
    def size(self): return _medinterp.MEDFLOAT_size(self)
    def clear(self): return _medinterp.MEDFLOAT_clear(self)
    def swap(self, *args): return _medinterp.MEDFLOAT_swap(self, *args)
    def get_allocator(self): return _medinterp.MEDFLOAT_get_allocator(self)
    def begin(self): return _medinterp.MEDFLOAT_begin(self)
    def end(self): return _medinterp.MEDFLOAT_end(self)
    def rbegin(self): return _medinterp.MEDFLOAT_rbegin(self)
    def rend(self): return _medinterp.MEDFLOAT_rend(self)
    def pop_back(self): return _medinterp.MEDFLOAT_pop_back(self)
    def erase(self, *args): return _medinterp.MEDFLOAT_erase(self, *args)
    def __init__(self, *args): 
        this = _medinterp.new_MEDFLOAT(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _medinterp.MEDFLOAT_push_back(self, *args)
    def front(self): return _medinterp.MEDFLOAT_front(self)
    def back(self): return _medinterp.MEDFLOAT_back(self)
    def assign(self, *args): return _medinterp.MEDFLOAT_assign(self, *args)
    def resize(self, *args): return _medinterp.MEDFLOAT_resize(self, *args)
    def insert(self, *args): return _medinterp.MEDFLOAT_insert(self, *args)
    def reserve(self, *args): return _medinterp.MEDFLOAT_reserve(self, *args)
    def capacity(self): return _medinterp.MEDFLOAT_capacity(self)
    def __iadd__(self, *args): return _medinterp.MEDFLOAT___iadd__(self, *args)
    def __add__(self, *args): return _medinterp.MEDFLOAT___add__(self, *args)
    def __isub__(self, *args): return _medinterp.MEDFLOAT___isub__(self, *args)
    def __sub__(self, *args): return _medinterp.MEDFLOAT___sub__(self, *args)
    def __imul__(self, *args): return _medinterp.MEDFLOAT___imul__(self, *args)
    def __mul__(self, *args): return _medinterp.MEDFLOAT___mul__(self, *args)
    def __idiv__(self, *args): return _medinterp.MEDFLOAT___idiv__(self, *args)
    def __div__(self, *args): return _medinterp.MEDFLOAT___div__(self, *args)
    def __le__(self, *args): return _medinterp.MEDFLOAT___le__(self, *args)
    def __lt__(self, *args): return _medinterp.MEDFLOAT___lt__(self, *args)
    def __gt__(self, *args): return _medinterp.MEDFLOAT___gt__(self, *args)
    def __ge__(self, *args): return _medinterp.MEDFLOAT___ge__(self, *args)
    def __eq__(self, *args): return _medinterp.MEDFLOAT___eq__(self, *args)
    def __ne__(self, *args): return _medinterp.MEDFLOAT___ne__(self, *args)
...
class MEDINT(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _medinterp.MEDINT_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _medinterp.MEDINT___nonzero__(self)
    def __bool__(self): return _medinterp.MEDINT___bool__(self)
    def __len__(self): return _medinterp.MEDINT___len__(self)
    def pop(self): return _medinterp.MEDINT_pop(self)
    def __getslice__(self, *args): return _medinterp.MEDINT___getslice__(self, *args)
    def __setslice__(self, *args): return _medinterp.MEDINT___setslice__(self, *args)
    def __delslice__(self, *args): return _medinterp.MEDINT___delslice__(self, *args)
    def __delitem__(self, *args): return _medinterp.MEDINT___delitem__(self, *args)
    def __getitem__(self, *args): return _medinterp.MEDINT___getitem__(self, *args)
    def __setitem__(self, *args): return _medinterp.MEDINT___setitem__(self, *args)
    def append(self, *args): return _medinterp.MEDINT_append(self, *args)
    def empty(self): return _medinterp.MEDINT_empty(self)
    def size(self): return _medinterp.MEDINT_size(self)
    def clear(self): return _medinterp.MEDINT_clear(self)
    def swap(self, *args): return _medinterp.MEDINT_swap(self, *args)
    def get_allocator(self): return _medinterp.MEDINT_get_allocator(self)
    def begin(self): return _medinterp.MEDINT_begin(self)
    def end(self): return _medinterp.MEDINT_end(self)
    def rbegin(self): return _medinterp.MEDINT_rbegin(self)
    def rend(self): return _medinterp.MEDINT_rend(self)
    def pop_back(self): return _medinterp.MEDINT_pop_back(self)
    def erase(self, *args): return _medinterp.MEDINT_erase(self, *args)
    def __init__(self, *args): 
        this = _medinterp.new_MEDINT(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _medinterp.MEDINT_push_back(self, *args)
    def front(self): return _medinterp.MEDINT_front(self)
    def back(self): return _medinterp.MEDINT_back(self)
    def assign(self, *args): return _medinterp.MEDINT_assign(self, *args)
    def resize(self, *args): return _medinterp.MEDINT_resize(self, *args)
    def insert(self, *args): return _medinterp.MEDINT_insert(self, *args)
    def reserve(self, *args): return _medinterp.MEDINT_reserve(self, *args)
    def capacity(self): return _medinterp.MEDINT_capacity(self)
    def __iadd__(self, *args): return _medinterp.MEDINT___iadd__(self, *args)
    def __add__(self, *args): return _medinterp.MEDINT___add__(self, *args)
    def __isub__(self, *args): return _medinterp.MEDINT___isub__(self, *args)
    def __sub__(self, *args): return _medinterp.MEDINT___sub__(self, *args)
    def __imul__(self, *args): return _medinterp.MEDINT___imul__(self, *args)
    def __mul__(self, *args): return _medinterp.MEDINT___mul__(self, *args)
    def __idiv__(self, *args): return _medinterp.MEDINT___idiv__(self, *args)
    def __div__(self, *args): return _medinterp.MEDINT___div__(self, *args)
    def __le__(self, *args): return _medinterp.MEDINT___le__(self, *args)
    def __lt__(self, *args): return _medinterp.MEDINT___lt__(self, *args)
    def __gt__(self, *args): return _medinterp.MEDINT___gt__(self, *args)
    def __ge__(self, *args): return _medinterp.MEDINT___ge__(self, *args)
    def __eq__(self, *args): return _medinterp.MEDINT___eq__(self, *args)
    def __ne__(self, *args): return _medinterp.MEDINT___ne__(self, *args)
...
class MEDCHAR(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _medinterp.MEDCHAR_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _medinterp.MEDCHAR___nonzero__(self)
    def __bool__(self): return _medinterp.MEDCHAR___bool__(self)
    def __len__(self): return _medinterp.MEDCHAR___len__(self)
    def pop(self): return _medinterp.MEDCHAR_pop(self)
    def __getslice__(self, *args): return _medinterp.MEDCHAR___getslice__(self, *args)
    def __setslice__(self, *args): return _medinterp.MEDCHAR___setslice__(self, *args)
    def __delslice__(self, *args): return _medinterp.MEDCHAR___delslice__(self, *args)
    def __delitem__(self, *args): return _medinterp.MEDCHAR___delitem__(self, *args)
    def __getitem__(self, *args): return _medinterp.MEDCHAR___getitem__(self, *args)
    def __setitem__(self, *args): return _medinterp.MEDCHAR___setitem__(self, *args)
    def append(self, *args): return _medinterp.MEDCHAR_append(self, *args)
    def empty(self): return _medinterp.MEDCHAR_empty(self)
    def size(self): return _medinterp.MEDCHAR_size(self)
    def clear(self): return _medinterp.MEDCHAR_clear(self)
    def swap(self, *args): return _medinterp.MEDCHAR_swap(self, *args)
    def get_allocator(self): return _medinterp.MEDCHAR_get_allocator(self)
    def begin(self): return _medinterp.MEDCHAR_begin(self)
    def end(self): return _medinterp.MEDCHAR_end(self)
    def rbegin(self): return _medinterp.MEDCHAR_rbegin(self)
    def rend(self): return _medinterp.MEDCHAR_rend(self)
    def pop_back(self): return _medinterp.MEDCHAR_pop_back(self)
    def erase(self, *args): return _medinterp.MEDCHAR_erase(self, *args)
    def __init__(self, *args): 
        this = _medinterp.new_MEDCHAR(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _medinterp.MEDCHAR_push_back(self, *args)
    def front(self): return _medinterp.MEDCHAR_front(self)
    def back(self): return _medinterp.MEDCHAR_back(self)
    def assign(self, *args): return _medinterp.MEDCHAR_assign(self, *args)
    def resize(self, *args): return _medinterp.MEDCHAR_resize(self, *args)
    def insert(self, *args): return _medinterp.MEDCHAR_insert(self, *args)
    def reserve(self, *args): return _medinterp.MEDCHAR_reserve(self, *args)
    def capacity(self): return _medinterp.MEDCHAR_capacity(self)
    def __iadd__(self, *args): return _medinterp.MEDCHAR___iadd__(self, *args)
    def __add__(self, *args): return _medinterp.MEDCHAR___add__(self, *args)
    def __isub__(self, *args): return _medinterp.MEDCHAR___isub__(self, *args)
    def __sub__(self, *args): return _medinterp.MEDCHAR___sub__(self, *args)
    def __imul__(self, *args): return _medinterp.MEDCHAR___imul__(self, *args)
    def __mul__(self, *args): return _medinterp.MEDCHAR___mul__(self, *args)
    def __idiv__(self, *args): return _medinterp.MEDCHAR___idiv__(self, *args)
    def __div__(self, *args): return _medinterp.MEDCHAR___div__(self, *args)
    def __le__(self, *args): return _medinterp.MEDCHAR___le__(self, *args)
    def __lt__(self, *args): return _medinterp.MEDCHAR___lt__(self, *args)
    def __gt__(self, *args): return _medinterp.MEDCHAR___gt__(self, *args)
    def __ge__(self, *args): return _medinterp.MEDCHAR___ge__(self, *args)
    def __eq__(self, *args): return _medinterp.MEDCHAR___eq__(self, *args)
    def __ne__(self, *args): return _medinterp.MEDCHAR___ne__(self, *args)
...
def MEDinterpCr(*args, **kwargs):
  """
    ...
    """
  return _medinterp.MEDinterpCr(*args, **kwargs)

def MEDinterpBaseFunctionWr(*args, **kwargs):
  """
    ...
    """
  return _medinterp.MEDinterpBaseFunctionWr(*args, **kwargs)

def MEDnInterp(*args, **kwargs):
  """
    ...
    """
  return _medinterp.MEDnInterp(*args, **kwargs)

def MEDinterpInfo(*args, **kwargs):
  """
    ...
    """
  return _medinterp.MEDinterpInfo(*args, **kwargs)

def MEDinterpInfoByName(*args, **kwargs):
  """
    ...
    """
  return _medinterp.MEDinterpInfoByName(*args, **kwargs)

def MEDinterpBaseFunctionRd(*args, **kwargs):
  """
    ...
    """
  return _medinterp.MEDinterpBaseFunctionRd(*args, **kwargs)

def MEDinterpBaseFunctionCoefSize(*args, **kwargs):
  """
    ...
    """
  return _medinterp.MEDinterpBaseFunctionCoefSize(*args, **kwargs)
