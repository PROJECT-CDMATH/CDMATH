...
class med_filter(_object):
    ...
    if _newclass:nspaces = _swig_property(_medenumtest.med_filter_nspaces_get, _medenumtest.med_filter_nspaces_set)
    ...
    if _newclass:memspace = _swig_property(_medenumtest.med_filter_memspace_get, _medenumtest.med_filter_memspace_set)
    ...
    if _newclass:diskspace = _swig_property(_medenumtest.med_filter_diskspace_get, _medenumtest.med_filter_diskspace_set)
    ...
    if _newclass:nentity = _swig_property(_medenumtest.med_filter_nentity_get, _medenumtest.med_filter_nentity_set)
    ...
    if _newclass:nvaluesperentity = _swig_property(_medenumtest.med_filter_nvaluesperentity_get, _medenumtest.med_filter_nvaluesperentity_set)
    ...
    if _newclass:nconstituentpervalue = _swig_property(_medenumtest.med_filter_nconstituentpervalue_get, _medenumtest.med_filter_nconstituentpervalue_set)
    ...
    if _newclass:constituentselect = _swig_property(_medenumtest.med_filter_constituentselect_get, _medenumtest.med_filter_constituentselect_set)
    ...
    if _newclass:switchmode = _swig_property(_medenumtest.med_filter_switchmode_get, _medenumtest.med_filter_switchmode_set)
    ...
    if _newclass:filterarraysize = _swig_property(_medenumtest.med_filter_filterarraysize_get, _medenumtest.med_filter_filterarraysize_set)
    ...
    if _newclass:filterarray23v30 = _swig_property(_medenumtest.med_filter_filterarray23v30_get, _medenumtest.med_filter_filterarray23v30_set)
    ...
    if _newclass:profilearraysize = _swig_property(_medenumtest.med_filter_profilearraysize_get, _medenumtest.med_filter_profilearraysize_set)
    ...
    if _newclass:storagemode = _swig_property(_medenumtest.med_filter_storagemode_get, _medenumtest.med_filter_storagemode_set)
    ...
    if _newclass:profilename = _swig_property(_medenumtest.med_filter_profilename_get, _medenumtest.med_filter_profilename_set)
    def __init__(self): 
...
class med_file_version(_object):
    ...
    if _newclass:majeur = _swig_property(_medenumtest.med_file_version_majeur_get, _medenumtest.med_file_version_majeur_set)
    ...
    if _newclass:mineur = _swig_property(_medenumtest.med_file_version_mineur_get, _medenumtest.med_file_version_mineur_set)
    ...
    if _newclass:release = _swig_property(_medenumtest.med_file_version_release_get, _medenumtest.med_file_version_release_set)
    def __init__(self): 
...
class med_memfile(_object):
    ...
    if _newclass:app_image_ptr = _swig_property(_medenumtest.med_memfile_app_image_ptr_get, _medenumtest.med_memfile_app_image_ptr_set)
    ...
    if _newclass:app_image_size = _swig_property(_medenumtest.med_memfile_app_image_size_get, _medenumtest.med_memfile_app_image_size_set)
    ...
    if _newclass:ref_count = _swig_property(_medenumtest.med_memfile_ref_count_get, _medenumtest.med_memfile_ref_count_set)
    ...
    if _newclass:fapl_image_ptr = _swig_property(_medenumtest.med_memfile_fapl_image_ptr_get, _medenumtest.med_memfile_fapl_image_ptr_set)
    ...
    if _newclass:fapl_image_size = _swig_property(_medenumtest.med_memfile_fapl_image_size_get, _medenumtest.med_memfile_fapl_image_size_set)
    ...
    if _newclass:fapl_ref_count = _swig_property(_medenumtest.med_memfile_fapl_ref_count_get, _medenumtest.med_memfile_fapl_ref_count_set)
    ...
    if _newclass:vfd_image_ptr = _swig_property(_medenumtest.med_memfile_vfd_image_ptr_get, _medenumtest.med_memfile_vfd_image_ptr_set)
    ...
    if _newclass:vfd_image_size = _swig_property(_medenumtest.med_memfile_vfd_image_size_get, _medenumtest.med_memfile_vfd_image_size_set)
    ...
    if _newclass:vfd_ref_count = _swig_property(_medenumtest.med_memfile_vfd_ref_count_get, _medenumtest.med_memfile_vfd_ref_count_set)
    __swig_setmethods__["flags"] = _medenumtest.med_memfile_flags_set
    __swig_getmethods__["flags"] = _medenumtest.med_memfile_flags_get
    if _newclass:flags = _swig_property(_medenumtest.med_memfile_flags_get, _medenumtest.med_memfile_flags_set)
    def __init__(self): 
